...
jest.mock('../parseLine', () => jest.fn().mockResolvedValue(JSON.parse(FIRST_LINE_INPUT)));
jest.mock('../writePayload', () => jest.fn().mockResolvedValue(null));

let parseLine = require('../parseLine');
let writePayload = require('../writePayload');
